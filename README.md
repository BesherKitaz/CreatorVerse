...
Submitted by: **Besher Kitaz**

About this web app: **A small app to perform basic CURD operations on a list of creators. You can use the app to view a list of creators, add, remove, update and view the details for every creator in the list. For each creator, you can see their name, a link to their platform, their photo, along a description of what they do.**
